    ...
    <form method="POST" action="{{ route('login') }}" class="w-full md:min-w-96 m-auto">
        ...
        <div class="flex flex-col items-center mt-4 gap-3">
            ...
            @if (Route::has('password.request'))
                <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('password.request', ['pl'=> $role_id]) }}">
