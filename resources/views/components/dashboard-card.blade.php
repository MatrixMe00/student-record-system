@props(["icon", "title", "context", "icon_bg" => "from-purple-700 to-pink-500", "actual_title" => ""])

<div {{ $attributes->merge(["class"=>"md:min-w-[240px] flex-auto px-3", "title" => $actual_title]) }}>
        ...
        <div class="flex justify-between flex-row -mx-3">
          <div class="px-3">
            <div>
              ...
              <h5 class="font-bold text-4xl mt-2">
                {{ $context }}
              </h5>
            </div>
          </div>
          <div class="px-3 text-right self-end">
