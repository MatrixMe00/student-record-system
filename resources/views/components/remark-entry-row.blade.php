@props(["remarkhead", "result" => null, "student" => "", "key", "totalmark",
...
>
    ...
    {{-- total score --}}
    <td>
        <x-text-input class="total" class="min-w-24 md:min-w-20 {{ $painttd }}" readonly :value="$result?->total_marks ?? $totalmark" name="total_marks[]" />
